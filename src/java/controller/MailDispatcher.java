...
public class MailDispatcher extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fromEmail = "bair.fernandes@rediffmail.com";
        String username = "blair.fernandes";
        String password = "blair@123";
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h4><a href='ShowJobAppln.jsp'>Back to Job Applications</a></h4>");
            out.println("</body>");
            out.println("</html>");
